...
class Ocr_tool(object):
    ...
    def ocr(self, image=None, url=None):
        ...
        if "高级资深王员" in word_lis: word_lis.append("高级资深干员")
...
if __name__=="__main__":
    ...
    url3="https://z3.ax1x.com/2021/09/22/4NTTSO.jpg"
    url4="https://s4.ax1x.com/2022/02/24/biVvTI.md.png"
    # im=ocr_t.read_image("tags.jpg")
    # im=ocr_t.crop_image(im)
    # word_lis=ocr_t.ocr(im)
    res=ocr_t.get_tags_from_url(url4)
    print(res)
